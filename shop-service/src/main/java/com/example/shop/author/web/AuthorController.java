...
import com.example.shop.author.Request.AuthorRequestDTO;
import com.example.shop.author.Request.AuthorRequestDtoUpdate;
import com.example.shop.author.Request.BookNestedUpdateRequest;
import com.example.shop.author.service.AuthorService;
import com.example.shop.book.web.BookController;
import com.example.shop.book.rep.BookRep;
...
public class AuthorController {
    ...
    @PutMapping("updateListBook/{authorId}")
    @ResponseStatus(HttpStatus.CREATED)
    @ResponseBody
    @Operation(
            summary = "Обновление связанных книг"
    )
    public AuthorView updateListBook(@PathVariable Long authorId, @Valid @RequestBody BookNestedUpdateRequest authorRequestDTO) {
        return service.updateListBook(authorId, authorRequestDTO);
    }
